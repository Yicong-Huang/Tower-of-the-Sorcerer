...
def board_canvas(parent, **config):
    ...
    THE_CANVAS.master.bind(
        '<Left>', lambda event: model.arrow_direction('left'))
    THE_CANVAS.master.bind(
        '<Right>', lambda event: model.arrow_direction('right'))
    THE_CANVAS.master.bind('<Up>', lambda event: model.arrow_direction('up'))
    THE_CANVAS.master.bind(
        '<Down>', lambda event: model.arrow_direction('down'))
