...
YELLOW_KEY_ICON = ImageTk.PhotoImage(
    Image.open('src/frame/yellow_key_icon.png'))
...
TRANSMIT_UP_ICON = ImageTk.PhotoImage(
    Image.open('src/item/hallow/transmit_up.png'))

TRANSMIT_DOWN_ICON = ImageTk.PhotoImage(
    Image.open('src/item/hallow/transmit_down.png'))
